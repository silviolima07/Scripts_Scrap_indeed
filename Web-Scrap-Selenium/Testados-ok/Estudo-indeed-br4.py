...
# sys.argv traz: Estudo-indeed-br3.py analista de dados
...
cargo, local, empresa, descricao = buscar_campos(driver, url_page, total_vagas)
...
df_final.to_csv("CSV/"+filename, index=False, header=True)
print("Diretório CSV\nCriado arquivo:", filename)
